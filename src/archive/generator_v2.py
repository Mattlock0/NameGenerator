...
class Generator:
    ...
    def generate_consonant(self) -> str:
        ...
        type_to_generate = weighted_choice({Symbols.CONSONANT: consonant_chance,
        ...
        return weighted_choice(ALL_SYMBOLS[type_to_generate])
    ...
    def generate_vowel(self) -> str:
        ...
        # choose one generation type based on weights
        type_to_generate = weighted_choice({Symbols.VOWEL: vowel_chance,
